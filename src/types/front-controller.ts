...
export interface GpdbRequests {
  complexSearch: (names: Array<Name>, meta?: Meta) => PromiseLike<{ [t in NameTypes]: Pronunciation[] }>,
  ...
  createRecording: (name: string, type: NameTypes, audio: string) => PromiseLike<void>,
...
type IFrontController = GpdbRequests & NamesServiceRequests & AnalyticsRequests & Partial<SettingsRequests>
